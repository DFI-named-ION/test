...
namespace FMVideoManagerApp.Core
{
    public sealed class FileIndexingState : ObservableObject
    {
        ...
        public string StorageName
        {
            ...
            internal set
            {
                if (_storageName != value)
                {
                    ...
                    OnPropertyChanged(nameof(FancyStatusMessage));
                }
            }
        }
        ...
        public int FailedFiles
        {
            ...
            internal set
            {
                if (_failedFiles != value)
                {
                    ...
                    OnPropertyChanged(nameof(FancyFailedFilesText));
                }
            }
        }

        public string FancyFailedFilesText => $"Failed: {FailedFiles}";
        ...
        public string FancyStatusMessage => StorageName != string.Empty ? $"{StorageName} - {StatusMessage}" : string.Empty;
